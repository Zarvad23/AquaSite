<template>
    <div class="container">
        <h2>Рыбы</h2>
        <p><b>Аквариумные рыбки</b> – удобные и полезные питомцы. Их часто заводят те люди, кто не может позволить себе кошку, собаку или попугая, но очень хочет иметь живого друга. Рыбки не вызывают аллергии, безопасны для астматиков, не шумят, не царапаются, не требуют выгула, спокойно переживут кратковременный отъезд хозяина. Они отлично уживаются с детьми и с любыми другими домашними животными.</p>
        <p><b>Аквариумные рыбки</b> – это и домашние животные, и элемент интерьера. Создайте для рыбок комфортные условия, и они создадут для вас необыкновенный уют и будут долго радовать глаз.
            Не подойдут аквариумные рыбки только тем людям, кто не готов приглядывать за ними и поддерживать чистоту аквариума, часто и подолгу находится в разъездах и командировках. Часто переезжать с аквариумом тоже не рекомендуется. Кроме того, что переезд большой стресс для обитателей аквариума, это еще и очень неудобно.</p>
        <h2>Виды рыб</h2>
        <div class="fish-types">
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://vorle.ru/media/imgs2019/5_Jup9hFJ.jpg')"></span>
                <h3>Хищники</h3>
            ...
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2020/03/okras-sovremennyh-akvariumnyh-rybok-porazhaet-svoim-mnogoobraziem.jpg')"></span>
                <h3>Необычные рыбки</h3>
                <span class="fish-type-desc">
                    <p>В эту категорию отнесены виды, обладающие одним или несколькими особенностями, не свойственными большинству других рыб. Например, удивительный внешний вид, непривычный способ питания, передвижения, оригинальный способ защиты и/или нападения и т. д</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://akvariumnyerybki.ru/wp-content/uploads/2016/01/viun-1-1-650x385.jpg')"></span>
                <h3>Вьюновые</h3>
                <span class="fish-type-desc">
                    <p>В природе населяют реки с быстрым бурным течением, поэтому в аквариумах нуждаются в схожих турбулентных условиях. Подобные требования к содержанию вкупе с непростым нравом создают сложности с выбором совместимых видов.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2019/09/zolotye-rybki-neprihotlivy-k-parametram-vody.jpg')"></span>
                <h3>Золотые рыбы</h3>
                <span class="fish-type-desc">
                    <p>Простые караси, которые за сотни лет искусственной селекции изменились до неузнаваемости (окраска, размер, форма тела и плавников). Селекция продолжается по сей день, поэтому количество новых форм постоянно увеличивается. Считаются самыми известными аквариумными рыбками</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://dreamaqua.ru/wp-content/uploads/2018/03/labeo-rybka-vidy_1-650x385.jpg')"></span>
                <h3>Карповые</h3>
                <span class="fish-type-desc">
                    <p>В эту группу входят такие популярные рыбки как данио, барбусы, расборы. В большинстве своём сравнительно небольшие в размерах, просты в содержании и разведении, прекрасно уживаются с другими видами. Всё это обусловило их широкое распространение среди любителей аквариумистики.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://zooclub.ru/attach/33000/33446.jpg')"></span>
                <h3>Харациновые</h3>
                <span class="fish-type-desc">
                    <p>Довольно разнообразная группа, объединяющая в себе и маленьких мирных тетр и хищных агрессивных пираний. Соответственно, условия и требования к содержанию к различным видам рыб будут сильно отличаться. Тем не менее, многие из них вполне подходят для начинающих аквариумистов.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2020/02/som-torakatum.jpg')"></span>
                <h3>Сомообразные</h3>
                <span class="fish-type-desc">
                    <p>Принадлежат к различным семействам и живут в самых разнообразных природных условиях. Не смотря на это, все сомы похожи друг на друга: обладают схожей формой тела и совершенно непритязательны к рациону. За небольшим исключением, сомы вырастают до внушительных размеров.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2018/10/koridoras-shterba.jpg')"></span>
                <h3>Сомики Коридорас</h3>
                <span class="fish-type-desc">
                    <p>Отдельная категория сомообразных, отличающаяся скромными размерами и миролюбивым нравом. Совершенно безопасны для других аквариумных рыбок и, так же как другие сомы, не вызовут больших трудностей при содержании.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://rybkivbanke.ru/wp-content/uploads/2020/04/a9d0f.jpg')"></span>
                <h3>Живородящие</h3>
                <span class="fish-type-desc">
                    <p>Обладают нехарактерным для большинства других рыб способом размножения. Они не мечут икру, а приносят полностью сформировавшихся мальков. Как правило, это небольшие неприхотливые рыбки, пользующиеся большой популярностью в любительской аквариумистике.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2020/03/petushki-samye-rasprostranennye-labirintovye-rybki.jpg')"></span>
                <h3>Лабиринтовые</h3>
                <span class="fish-type-desc">
                    <p>Главным образом эта группа состоит из бойцовых рыбок — петушков и гурами. Их объединяет наличие особого дыхательного органа, насыщающего кровь кислородом. Его строение напоминает лабиринт из кровеносных сосудов, благодаря которому рыбки и получили своё название.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://akvarium-moskva.ru/images/dbc432071adb02c456a9c5ae1f6896af.jpg')"></span>
                <h3>Радужницы</h3>
                <span class="fish-type-desc">
                    <p>Экзотические рыбки с берегов Австралии и близлежащих островов. Название полностью соответствует их облику с яркой переливающейся окраской. Сравнительно неприхотливы, тем не менее требуют определённого опыта для содержания.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                ...
                <h3>Рыбки Килли</h3>
                <span class="fish-type-desc">
                    <p>Удивительные представители карпозубых. Обладают ярким радужным окрасом, мирным нравом, уживчивы и очень просты в содержании. Единственный недостаток — очень низкая продолжительность жизни, всего пару лет.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type">
                <span class="fish-type-image"
                      style="background-image: url('https://blog.tetra.net/ru/ru/wp-content/uploads/2018/11/geofagus-brazilskij-cihlida-iz-yuzhnoj-ameriki.jpg')"></span>
                <h3>Цихлиды</h3>
                <span class="fish-type-desc">
                    <p>Рыбки этой группы относятся к одному семейству цихловых, которые населяют реки и озёра Южной и Центральной Америк, Африки и Юго-Восточной Азии. Не смотря на общее происхождение, представители того или иного региона будут значительно отличаться по условиям содержания и поведением.</p>
                    <a class="fish-type-btn">Представители</a>
                </span>
            </div>
            <div class="fish-type-another">
                <router-link  to="/another" style="background-image: url('//pic.onlinewebfonts.com/svg/img_282882.svg')"></router-link>
                <p>Другие виды</p>
            </div>
        </div>
    </div>
